...
const BusinessPlan = ({ plan, user, onInit, onNullPlan, onClear, onNeedMoreComments }) => {
    ...
    function humanizeDate(ts) {
        ...
        return `${getHumanizedMonth(dt.getMonth())} ${dt.getDate()}, ${dt.getFullYear()} ${dt.getHours()}:${dt.getMinutes()}`;
    }
                                    ...
                                    <div className={styles.summaryWrapper}>
                                        <div className={styles.summaryBlock}>
                                            ...
                                            <div className={styles.summaryContent}>
                                                <SummaryStat header={'category'} content={<p className={styles.summaryText}>Food</p>} style={{ width: '150px' }} />
                                                <SummaryStat header={'type'} content={<p className={styles.summaryText}>Franchise</p>} style={{ width: '150px' }} />
                                    ...
                                    <div className={styles.commentsBlockWrapper}>
                                        ...
                                        <div className={styles.commentsContent}>
                                            ...
                                            <div>
                                                ...
                                                {
                                                    plan.comments.needMore && !plan.comments.isLoading ? <div onClick={() => { onNeedMoreComments(plan.activeBusiness, plan.activeEdition); }}><p className={styles.commentsEvent}>load more comments</p></div> : plan.comments.needMore ? <p className={styles.commentsEvent}>COMMENTS LOADING</p> : null
                                                }
                                            </div>
                                        </div>
